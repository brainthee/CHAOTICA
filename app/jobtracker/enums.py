...
class PhaseStatuses():
    ...
    CHANGEABLE_FIELDS = (
        (DRAFT, [
            "phase_number", "title", "service", "description", 
            "test_target", "comm_reqs", 
            "delivery_hours", "reporting_hours", "mgmt_hours", "qa_hours", 
            "oversight_hours", "debrief_hours", "contingency_hours", "other_hours",
            "desired_start_date", "due_to_techqa_set", "due_to_presqa_set", "desired_delivery_date",
            "is_testing_onsite", "is_reporting_onsite", "number_of_reports", "report_to_be_left_on_client_site",
            "location", "restrictions", "scheduling_requirements", "prerequisites",
            ]), 
        (PENDING_SCHED, [
            "phase_number", "title", "service", "description", 
            "test_target", "comm_reqs", 
