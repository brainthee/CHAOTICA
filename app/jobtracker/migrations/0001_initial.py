    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "Job",
                "ordering": ["id"],
                "permissions": (("scope_job", "Can Scope Job"),),
            },
        ),
        migrations.CreateModel(
            name="Link",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        default="default.jpg",
                        upload_to=jobtracker.models.get_media_image_file_path,
                    ),
                ),
                (
                    "targetProfit",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=jobtracker.models._default_business_days,
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="presqa_phases",
                        to="jobtracker.feedback",
                        verbose_name="Pres QA Feedback",
                    ),
                ),
                (
                    "feedback_scope",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="scope_phases",
                        to="jobtracker.feedback",
                        verbose_name="Scope Feedback",
                    ),
                ),
                (
                    "feedback_techqa",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="techqa_phases",
                        to="jobtracker.feedback",
                        verbose_name="Tech QA Feedback",
                    ),
                ),
                (
                    "job",
