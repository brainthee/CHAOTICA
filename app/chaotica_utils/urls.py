...
urlpatterns = [
    ...
    path("autocomplete/cities", views.city_autocomplete, name="city-autocomplete"),
    ...
    path(
        "ops/holidays/import_lib/", views.holiday_import_lib, name="holiday_import_lib"
    ),
    path(
    ...
    path(
        "ops/job-levels/<int:pk>/delete/",
        views.job_level_delete,
        name="job_level_delete",
    ),
    path("ops/job-levels/assign/", views.assign_job_level, name="assign_job_level"),
    path(
        "ops/job-levels/history/",
        views.user_job_level_history,
        name="user_job_level_history",
    ),
    path(
        "ops/job-levels/import/",
        views.import_job_level_assignments,
        name="import_job_level_assignments",
    ),
    path(
        "ops/job-levels/template/",
        views.download_job_level_template,
        name="download_job_level_template",
    ),
    # Settings
    ...
    path(
        "settings/csv_template/users",
        views.csv_template_users,
        name="csv_template_users",
    ),
    path(
        "settings/regenerate_api_key",
        views.regenerate_health_api_key,
        name="regenerate_health_api_key",
    ),
    path(
        "settings/backup/db/download",
        views.download_db_backup,
        name="download_db_backup",
    ),
    path(
        "settings/backup/media/download",
        views.download_media_backup,
        name="download_media_backup",
    ),
    path(
        "settings/backup/db/restore", views.restore_db_backup, name="restore_db_backup"
    ),
    path(
        "settings/backup/media/restore",
        views.restore_media_backup,
    ...
    path(
        "profile/update", views.update_own_profile, name="update_own_profile"
    ),  # redirect to edit profile
    path("profile/theme", views.update_own_theme, name="update_own_theme"),
    path(
        "profile/api-token/create",
        views.create_own_api_token,
        name="create_own_api_token",
    ),
    path(
        "profile/api-token/reset",
        views.reset_own_api_token,
        name="reset_own_api_token",
    ),
    path(
        "profile/api-token/revoke",
        views.revoke_own_api_token,
        name="revoke_own_api_token",
    ),
    ...
    path(
        "profile/<str:email>/update/skills", views.update_skills, name="update_skills"
    ),
    path("profile/<str:email>/update/certs", views.update_certs, name="update_certs"),
    path(
        "profile/<str:email>/onboarding/", views.view_onboarding, name="view_onboarding"
    ),
    path(
        "profile/<str:email>/onboarding/renew/<int:pk>",
        views.renew_onboarding,
        name="renew_onboarding",
    ),
    path(
        "profile/<str:email>/schedule/timeslots/",
        views.user_schedule_timeslots,
        name="user_schedule_timeslots",
    ),
    path(
        "profile/<str:email>/schedule/holidays/",
        views.user_schedule_holidays,
        name="user_schedule_holidays",
    ),
    ...
    path(
        "profile/<str:email>/feedback/",
        views.user_feedback_summary,
        name="user_feedback_summary",
    ),
