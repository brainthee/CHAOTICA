...
urlpatterns = [
    ...
    path('reports/<uuid:uuid>/runs/<uuid:run_id>/status/', reports.report_run_status, name='report_run_status'),
    path('reports/<uuid:uuid>/runs/<uuid:run_id>/result/', reports.report_run_result, name='report_run_result'),
