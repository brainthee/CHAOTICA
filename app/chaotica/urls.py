...
# django-debug-toolbar is a dev-only dependency (see requirements-dev.txt) and is not
# installed in the production image, so keep the import guarded behind DEBUG.
if settings.DEBUG:
